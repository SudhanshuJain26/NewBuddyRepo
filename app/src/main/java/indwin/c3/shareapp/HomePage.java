...
public class HomePage extends AppCompatActivity {
    ...
    private class linkSearch extends
                             AsyncTask<String, Void, String> {
        @Override
        protected void onPreExecute() {
            //            spinner.setVisibility(View.VISIBLE);
        ...
        protected void onPostExecute(String result) {
            if (!result.equals("win")) {
                ...
                int monthsallowed = months(searchSubcategory, searchCategory, searchBrand, searchPrice);
                int monthscheck = 0;
                //digo
                ...
                if (searchPrice <= 5000) {
                    ...
                    in.putExtra("query", query.getText().toString().trim());
