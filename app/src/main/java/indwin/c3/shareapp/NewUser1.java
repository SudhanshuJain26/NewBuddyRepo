...
//                new SendSelectedContactstoServer(getContext()).execute();
                ...
                SharedPreferences prefs = getContext().getSharedPreferences("preferencename1", 0);
                SharedPreferences.Editor editor = prefs.edit();
                editor.putInt("mChecked_size", mChecked.size());

                for(int i=0;i<mChecked.size();i++)
                    editor.putBoolean( "mChecked_" + i, mChecked.get(i));
...
// add elements to al, including duplicates
                    ...
                    editor1.putString("phone_contacts_selected", json);
                    editor1.commit();
...
//        }
    ...
    public  static NewUser1 init(ArrayList<Friends> list) {
        NewUser1 fragment = new NewUser1();
...
//
    ...
    public SparseBooleanArray getArray(){
        ...
        for(int i=0;i<friendsArrayList.size();i++)
            array.put(i,prefs.getBoolean("mChecked_"+i,false));
