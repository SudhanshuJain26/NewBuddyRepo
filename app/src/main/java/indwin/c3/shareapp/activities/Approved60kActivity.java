 ...
 */
public class Approved60kActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        flashRejectedText1.setText("Rs.60000!");
        unlockMoreCredit.setVisibility(View.GONE);
        searchProduct.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Approved60kActivity.this, HomePage.class);
    ...
    public void onBackPressed() {
        super.onBackPressed();
        Intent intent = new Intent(Approved60kActivity.this, ProfileActivity.class);
        intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
        startActivity(intent);
        finish();
    }
