 ...
 */
public class Rejected60kActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        flashRejectedText1.setText("Rs.60000 Credit for you.");

        unlockMoreCredit.setText("Find out why!");
        ...
        searchProduct.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Rejected60kActivity.this, HomePage.class);
    ...
    public void onBackPressed() {
        super.onBackPressed();
        Intent intent = new Intent(Rejected60kActivity.this, ProfileActivity.class);
        intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
        startActivity(intent);
        finish();
    }
