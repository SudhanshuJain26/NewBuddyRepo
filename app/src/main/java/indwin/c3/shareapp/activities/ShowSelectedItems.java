    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        phone.setOnClickListener(new View.OnClickListener() {
            ...
            if(checkAndRequestPermissions()) {
                ...
                Toast.makeText(getApplicationContext(),"Please allow to read contacts to send invites",Toast.LENGTH_LONG);
            }
//                phoneInvited.setVisibility(View.GONE);
//                emailInvited.setVisibility(View.GONE);
            }
...
//        }
        ...
        if (!listPermissionsNeeded.isEmpty()) {
            ActivityCompat.requestPermissions(this, listPermissionsNeeded.toArray(new String[listPermissionsNeeded.size()]),REQUEST_CONTACTS_PERMISSIONS);
            return false;
        }
        return true;
    }
